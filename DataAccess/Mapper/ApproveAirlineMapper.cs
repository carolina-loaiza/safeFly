...
{
    public class ApproveAirlineMapper : EntityMapper, ISqlStatements, IObjectMapper
    {
        ...
        {
            var operation = new SqlOperation { ProcedureName = "RET_ALL_PENDING_AIRLINE_APPROVAL_PR" };
        ...
        /// <summary>
        /// UPDATE AIRLINE APPROVAL PROCEDURE
        /// </summary>
        ...
        {
            var operation = new SqlOperation { ProcedureName = "UPD_AIRLINE_APPROVAL_PR" };
