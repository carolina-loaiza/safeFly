...
namespace WebAPI.Controllers
{
    public class ContactUsController : ApiController
    {
        ...
        private static void enviarCorreo(ContactUs contactus)
        {
            ...
            mmsg.Body = ("Correo enviado por: " + contactus.FirstName + 
                          ". Correo electronico: " + contactus.Email +
                          ". Con el siguiente mensaje: " + contactus.Comment);  //mensaje del usuario para SafeFly
